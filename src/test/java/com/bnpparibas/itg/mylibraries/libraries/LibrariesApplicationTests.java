...
import com.bnpparibas.itg.mylibraries.libraries.domain.Address;
import com.bnpparibas.itg.mylibraries.libraries.domain.Director;
...
class LibrariesApplicationTests {
	...
	class Test_update{
		...
		void test_update_1(){
			//--------------- Given ---------------
			Library librarySaved = libraryDAO.save(NATIONAL_LIBRARY_MONTREUIL);

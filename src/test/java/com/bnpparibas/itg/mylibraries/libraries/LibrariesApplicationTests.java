...
import static com.bnpparibas.itg.mylibraries.libraries.DatabaseTestHelper.*;
...
class LibrariesApplicationTests {
	...
	void test_read_one(){
		//--------------- Given ---------------
		Library dummyLibrary = databaseTestHelper.createDummyLibrary();
	...
	void test_create_1(){
		...
		//--------------- When ---------------
		// I do a request on /libraries
		LibraryDTO mantional_library_montreuil_dto = new LibraryDTO(
		...
		ResponseEntity<Long> response = restTemplate.postForEntity("/libraries", mantional_library_montreuil_dto, Long.class);
		...
		Optional<Library> libraryFromDB = libraryDAO.findById(idCreated);
	...
	class Test_update{
		...
		void test_update_1(){
			...
			//--------------- Then ---------------
			Optional<Library> libraryFromDB = libraryDAO.findById(idOfCreatedLibrary);
			assertThat(libraryFromDB).isNotEmpty();
	...
	class Test_delete{
		...
		void test_delete_1(){
			//--------------- Given ---------------
			Library librarySaved = databaseTestHelper.createDummyLibrary();
			...
			//--------------- Then ---------------
			Optional<Library> libraryFromDB = libraryDAO.findById(idOfSavedLibrary);
